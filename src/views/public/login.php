                ...
                <div class="mb-md-3 mt-md-2 pb-3">
                  ...
                  <form action="/StreamSync/src/controllers/auth/login.php" method="post" class="p-4">
                    <div class="form-group mb-3 mt-3">
                      <label for="Email" class="form-label d-flex justify-content-start align-items-start">Email</label>
                      <input type="email" class="form-control" id="Email" placeholder="Email" name="email" maxlength="255" />
                    </div>

                    <div class="form-group mb-3">
                      <label for="password" class="form-label d-flex justify-content-start align-items-start">Password</label>
                    ...
                    <div class="d-flex justify-content-center text-center mt-4 pt-1">
                      <a href="https://github.com/DiogoBernardes/Movies-and-or-Series-Management" class="text-white transition"><i class="bi bi-github bi-4x"></i></a>
                      <a href="https://www.instagram.com/streamsync_/" class="text-white mx-4 px-2 transition"><i class="bi bi-instagram"></i></a>
                      <a href="https://twitter.com/SSync27157" class="text-white transition"><i class="bi bi-twitter"></i></a>
                    </div>

                    <div class="mt-2">
                      <p>Ainda não tem conta?<a href="/StreamSync/src/views/public/register.php" class="text-white-50 fw-bold ms-2">Registe-se agora!</a></p>
                    </div>

          ...
          <tbody>
            ...
            foreach ($users as $user) {
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex justify-content">
                    <a href="/StreamSync/controllers/admin/user.php?<?= 'user=update&id=' . $user['id'] ?>"><button type="button"
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="/StreamSync/controllers/admin/user.php?<?= 'user=delete&id=' . $user['id'] ?>"><button type="button"

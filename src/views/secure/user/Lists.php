          ...
          <div class="carousel-item <?= ($i == 1) ? 'active' : ''; ?>">
            <div class="row">
              ...
              <?php foreach (array_slice($lists, $startIndex, $itemsPerPage) as $list) : ?>
                <div class="col-lg-4 col-md-6 col-sm-12 mt-4 mb-3 d-flex justify-content-center py-3">
                  <div class="card z-index-2 w-80 card-color">
                    ...
                    <div class="card-body ">
                      ...
                      <div class="d-flex ">
                        <i class="material-icons text-sm my-auto me-1 ms-2"></i>
                        <p class="mb-0 text-sm" <?= $list['updated_at']; ?>></p>
                      </div>
                    </div>
                  </div>
                </div>
